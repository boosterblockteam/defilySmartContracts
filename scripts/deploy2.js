...
async function deploy() {
    ...
    const providerUrls = [
        "https://polygon-rpc.com/", // AsegÃºrate de usar un URL confiable para Polygon
    ];
    ...
    const waitForConfirmations = async (tx) => {
        console.log(`Esperando 12 confirmaciones para la transacciÃ³n ${tx.hash}...`);
        await tx.wait(12);
        console.log(`TransacciÃ³n ${tx.hash} confirmada!`);
    };
    ...
    const POI2 = await ethers.getContractFactory("POI", signer);
    ...
    await hre.run("verify:verify", {
        address: "0xc13050BAf0C90a5Fb92beabaB452930f846FF1a4",
